...
func (c *Config) register() {
	...
	flag.StringVar(&c.DataDirectory, "data-dir", c.DataDirectory, "directory to store app data (defaults to ~/.mzcoin)")
	flag.StringVar(&c.DBPath, "db-path", c.DBPath, "path of database file (defaults to ~/.mzcoin/data.db)")
	...
	flag.StringVar(&c.WalletDirectory, "wallet-dir", c.WalletDirectory, "location of the wallet files. Defaults to ~/.mzcoin/wallet/")
...
var devConfig = Config{
	...
	PeerListURL:            "https://downloads.mzcoin.net/blockchain/peers.txt",
	...
	LaunchBrowser: false,
	// Data directory holds app data -- defaults to ~/.mzcoin
	DataDirectory: filepath.Join(home, ".mzcoin"),
